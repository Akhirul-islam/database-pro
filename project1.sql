...
INSERT INTO users (NID, age, DOB, username, name, address) VALUES (1909026, 22, TO_DATE('2001-07-29', 'YYYY-MM-DD'), 'Ab123', 'Abir', 'Brahmanbaria');
INSERT INTO users (NID, age, DOB, username, name, address) VALUES (1909056, 28, TO_DATE('1995-02-10', 'YYYY-MM-DD'), 'Ifty123', 'Ifty', 'Brahmanbaria');
INSERT INTO users (NID, age, DOB, username, name, address) VALUES (1909027, 32, TO_DATE('1989-09-15', 'YYYY-MM-DD'), 'riya123', 'Riyad', 'Rajshahi');
INSERT INTO users (NID, age, DOB, username, name, address) VALUES (1907117, 25, TO_DATE('1998-07-12', 'YYYY-MM-DD'), 'sami123', 'Sami', 'Sylhet');
INSERT INTO users (NID, age, DOB, username, name, address) VALUES (1909022, 30, TO_DATE('1992-03-20', 'YYYY-MM-DD'), 'Nihi', 'Nihima', 'Rajshahi');
INSERT INTO users (NID, age, DOB, username, name, address) VALUES (1909005, 25, TO_DATE('1996-08-10', 'YYYY-MM-DD'), 'joyi', 'joyita', 'Dhaka');
INSERT INTO users (NID, age, DOB, username, name, address) VALUES (1907120, 35, TO_DATE('1986-12-05', 'YYYY-MM-DD'), 'rabbi123', 'Rabbi', 'Vola');
INSERT INTO users (NID, age, DOB, username, name, address) VALUES (1909054, 28, TO_DATE('1993-07-15', 'YYYY-MM-DD'), 'show', 'shoardya', 'Chittagong');
...
SELECT 1907,t.train_id,TO_DATE('2023-05-20','YYYY-MM-DD'),u.name, c.class_type,t.source,t.destination,18,1909026
FROM train t
JOIN class c ON t.train_id = c.train_id
JOIN users u ON u.username = 'Ab123'
...
FROM train t
JOIN class c ON t.train_id = c.train_id
JOIN users u ON u.username = 'Ifty123'
...
FROM train t
JOIN class c ON t.train_id = c.train_id
JOIN users u ON u.username = 'Joyi'
...
FROM train t
JOIN class c ON t.train_id = c.train_id
JOIN users u ON u.username = 'Nihi' 
